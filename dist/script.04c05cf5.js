...
$(document).ready(function () {
  ...
  function addEventDate() {
    ...
    var eventDate = Date.parse("24th July, 2025");
    ...
    var formattedDate;
    if (typeof eventDate.toString === "function" && eventDate.toString.length > 0) {
      try {
    ...
    $("#event-date").text("".concat(formattedDate));
  }
...
function setSnowflakeStyle(flake) {
  ...
  flake.style.animationDuration = "".concat(randomBetween(8, 16), "s");
